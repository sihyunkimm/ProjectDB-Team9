...
- **이번 회차 목표:** Godot 엔진 분석을 위한 역할 재분담 및 분석 범위 세분화
- **현재 진행률:** 10% (전체 일정 대비)
- **주요 달성 사항:**
    - **분석 범위 세분화:** 광범위한 Godot 오픈소스에서 분석 범위 추출
    - **역할 분담:** 효율적인 Godot 엔진 분석을 위해 각자 분석 범위 할당

## 개인별 기여 내역

> 효율적인 Godot 엔진 분석 / 취약점 점검을 위해 세분화된 역할 분담을 목표로 한다. 

> 2주차 프로젝트 링크: https://www.notion.so/Gguard-week-2-364bc6703126801e9121d903002b2310
...
- **문제 상황:** 분석할 내용이 명확하게 분배되지 않아 혼란이 있음.
- **해결 현황:** 분석할 내용 및 오픈소스 상의 코드 범위를 명확하게 정함.


## 다음 회차 목표

- **파트별 공식 문서 정독:** 각자 파트별로 공식 문서를 정독하고, 해당 내용을 공유.
- **파트별 오픈소스 코드 분석:** Godot의 오픈소스 코드를 분석하고, 해당 내용을 공유 및 공통된 내용에 대해 토의.
- **취약점 스터디:** 게임 엔진에서 자주 볼 수 있는 취약점, Godot 엔진에서 사용하는 라이브러리의 취약점, 취약점 분석 도구 등을 정리하여, 추후 취약점 분석 기간에 효율적으로 점검할 수 있도록 함.
